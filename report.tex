...
\author{
    ...
    \textbf{Submission Date:} 29 July 2026 \\[0.05in]
...
\begin{itemize}
    \item Most learning happens in the first 20 epochs, with accuracy rising from $\sim$36\% to $\sim$95\%
    \item Loss decreases steadily without significant oscillation, indicating stable training
    \item Validation accuracy closely tracks training accuracy, showing no overfitting
...
\begin{itemize}
    ...
    \item \textbf{Momentum} was slower but outperformed SGD, reaching 91\% validation accuracy
...
The learning rate schedule changed training by:
\begin{itemize}
...
• Generating test cases and validating outputs \\
• Helping structure and format the report \\[0.1in]
All code was written, understood, and verified by me. \\
I can explain and reproduce everything submitted without these tools.
}}
\end{center}
...
\begin{itemize}
    ...
    \item Goodfellow, I., Bengio, Y., \& Courville, A. (2016). \textit{Deep Learning}. MIT Press. Ch. 6 (Backpropagation), Ch. 7 (Regularization), Ch. 8 (Optimization)
    \item Kingma, D. P., \& Ba, J. (2015). Adam: A Method for Stochastic Optimization. \textit{ICLR 2015}.
    \item Karpathy, A. \textit{micrograd} -- autograd engine inspiration
\end{itemize}
